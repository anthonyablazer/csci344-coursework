        ...
        <>
            ...
            <main className="min-h-screen max-w-[1000px] mt-24 mx-auto">
                ...
                <Timeline
                    items={[
                        {
                            children: 'Finish Tutorial08 03-28-2025',
                        },
                        {
                            children: 'Maybe study for Quiz 2B 03-30-2025',
                        },
                        {
                            children: 'Quiz 2B 02-31-2025',
                        },
                        {
                            children: 'Get Quiz 2B grade back ??-??-????',
                        },
                    ]}
                />
                ...
                <div>
                    <>
                        ...
                        <Modal title="Basic Modal" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                            <p><a href="https://wiki.archlinux.org/title/Installation_guide">Click here please!</a></p>
                        </Modal>
                    </>
                </div>
